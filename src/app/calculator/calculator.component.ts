  ...
  ngOnInit(): void {
    ...
    this.route.queryParams.subscribe((params) => {
      this.calculatorForm.setValue({
        ...
        serviceTime: params['serviceTime'] || null,
        frequency: params['frequency'] || 'One Time',
        entryMethod: params['entryMethod'] || '',
        specialInstructions: params['specialInstructions'] || null,
        sameDay: params['sameDay'] || null,
        deepCleaning: params['deepCleaning'] || null,
        insideOfClosets: params['insideOfClosets'] || null,
        insideTheOven: params['insideTheOven'] || null,
        insideTheFridge: params['insideTheFridge'] || null,
        washingDishes: params['washingDishes'] || null,
        wallCleaning: params['wallCleaning'] || null,
        insideWindows: params['insideWindows'] || null,
        petHairClean: params['petHairClean'] || null,
        insideCabinets: params['insideCabinets'] || null,
        balcony: params['balcony'] || null,
        supplies: params['supplieხs'] || null,
        office: params['office'] || null,
        laundry: params['laundry'] || null,
        folding: params['folding'] || null,
        organizing: params['organizing'] || null,
        vacuum2: params['vacuum2'] || null,
      ...
      switch (type) {
        ...
        // გაგისწორე ეს, cleaning servie ში თუ movein/moveout აირჩევს,
        // serviceType ში შესაბამისი value აისახება, არასწორად გქონდა get ით ამოღებული params
        // case 'moveIn':
